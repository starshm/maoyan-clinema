...
public class OrderServiceImpl2020 implements OrderServiceAPI {
    ...
    public boolean isTrueSeats(String fieldId, String seats) {
        // 根据FieldId找到对应的座位位置图
        String seatPath = order2020TMapper.getSeatsByFieldId(fieldId);
    ...
    public boolean isNotSoldSeats(String fieldId, String seats) {
        ...
        List<Order2020T> list = order2020TMapper.selectList(entityWrapper);
        String[] seatArrs = seats.split(",");
        // 有任何一个编号匹配上，则直接返回失败
        for(Order2020T OrderT : list){
    ...
    public OrderVO saveOrderInfo(
        ...
        order2020T.setOrderPrice(totalPrice);
        ...
        if(insert>0){
            // 返回查询结果
            OrderVO orderVO = order2020TMapper.getOrderInfoById(uuid);
    ...
    public Page<OrderVO> getOrderByUserId(Integer userId,Page<OrderVO> page) {
        ...
        if(userId == null){
            ...
            List<OrderVO> ordersByUserId = order2020TMapper.getOrdersByUserId(userId,page);
            if(ordersByUserId==null && ordersByUserId.size()==0){
                ...
                Integer counts = order2020TMapper.selectCount(entityWrapper);
                // 将结果放入Page
    ...
    public String getSoldSeatsByFieldId(Integer fieldId) {
        if(fieldId == null){
            ...
            String soldSeatsByFieldId = order2020TMapper.getSoldSeatsByFieldId(fieldId);
    ...
    public OrderVO getOrderInfoById(String orderId) {
        ...
        OrderVO orderInfoById = order2020TMapper.getOrderInfoById(orderId);
    ...
    public boolean paySuccess(String orderId) {
        ...
        Integer integer = order2020TMapper.updateById(order2020T);
        if(integer>=1){
            return true;
        }else{
            return false;
