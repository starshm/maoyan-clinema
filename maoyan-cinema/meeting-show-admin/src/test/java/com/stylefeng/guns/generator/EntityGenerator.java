...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("H:\\code\\minghai\\maoyan-clinema\\maoyan-cinema\\meeting-show-admin\\src\\main\\java");//这里写你自己的java目录
        ...
        dsc.setUrl("jdbc:mysql://101.133.138.114:3306/guns_rest?characterEncoding=utf8");
...
//        strategy.setInclude(new String[]{"area_dict_t","brand_dict_t"});
//        strategy.setInclude(new String[]{"cinema_t","hall_dict_t"});
