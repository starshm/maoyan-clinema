...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("H:\\code\\minghai\\maoyan-clinema\\maoyan-cinema\\guns-show\\src\\main\\java");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[]{"show_t","show_type_dict_t"});
